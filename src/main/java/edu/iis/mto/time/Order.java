...
public class Order {
    ...
    private DateTime subbmitionDate, cancelTime = null;

    public Order() {
        orderState = State.CREATED;
    }

    public Order(DateTime cancelTime) {
        orderState = State.CREATED;
    ...
    public void confirm() {
        ...
        if (cancelTime != null) {
            hoursElapsedAfterSubmittion = Hours.hoursBetween(subbmitionDate, cancelTime).getHours();
        } else {
